...
export class ResizeBlock extends Group {
  constructor({ pos = [0, 0], size = [100, 30], bgcolor = '#eee', borderColor = 'transparent', borderWidth = 1, dragRect = [] }) {
    super()
    this.size = size
  ...
  init() {
    ...
    this.attr({ size: this.size, bgcolor: this.bgcolor, border: [this.borderWidth, this.borderColor] })
    let $drag = new Sprite()
