...
let i = 0
const { Scene, Sprite, Group, Node } = spritejs,
  w = window.innerWidth,
...
spriteGreen.attr({ bgcolor: 'rgba(0,255,0,0.2)', size: [100, 30], pos: [300, 300] }).draggable()
layer.append(spriteGreen)
spriteGreen.addEventListener('beforerender', function() {
  console.log('append')
})
console.log(spriteGreen)
